 ...
 */
Ext.define("seava.ad.ui.extjs.dc.User_Dc", {
	extend: "e4e.dc.AbstractDc",
	paramModel: seava.ad.ui.extjs.ds.User_DsParam,
	recordModel: seava.ad.ui.extjs.ds.User_Ds
});

/* ================= FILTER FORM: Filter ================= */

Ext.define("seava.ad.ui.extjs.dc.User_Dc$Filter", {
...
Ext.define("seava.ad.ui.extjs.dc.User_Dc$List", {
...
Ext.define("seava.ad.ui.extjs.dc.User_Dc$Edit", {
	...
	_defineElements_: function() {
		...
		.addPanel({ name:"col2", _hasTitle_: true, width:300,  xtype:"fieldset", collapsible:true, border:true, defaults: { labelWidth:"120"}, layout:"form"});
	},
...
Ext.define("seava.ad.ui.extjs.dc.User_Dc$ChangePasswordForm", {
	extend: "e4e.dc.view.AbstractDcvEditForm",
