...
Ext.define("seava.ad.ui.extjs.dc.Client_Dc$Edit", {
	...
	_defineElements_: function() {
		...
		.addPanel({ name:"col2", _hasTitle_: true, width:550,  xtype:"fieldset", collapsible:true, border:true, defaults: { labelWidth:"120"}, layout:"form"});
	},
...
Ext.define("seava.ad.ui.extjs.dc.Client_Dc$Create", {
	...
	_defineElements_: function() {
		...
		.addPanel({ name:"col3", _hasTitle_: true, width:550,  xtype:"fieldset", collapsible:true, border:true, defaults: { labelWidth:"120"}, layout:"form"});
	},
