 ...
 */
Ext.define(Main.ns.ad + "DateFormat_Ui" , {
	...
	_defineDcs_: function() {
		this._getBuilder_()	
		.addDc("fmt", Ext.create(Main.ns.ad + "DateFormat_Dc" ,{multiEdit:true}))	
		.addDc("mask", Ext.create(Main.ns.ad + "DateFormatMask_Dc" ,{multiEdit:true}))
