 ...
 */
Ext.define(Main.ns.ad + "DataSource_Ui" , {
	...
	_defineDcs_: function() {
		this._getBuilder_()	
		.addDc("ds", Ext.create(Main.ns.ad + "DataSource_Dc" ,{}))	
		.addDc("fields", Ext.create(Main.ns.ad + "DataSourceField_Dc" ,{}))	
		.addDc("rpcs", Ext.create(Main.ns.ad + "DataSourceRpc_Dc" ,{}))
