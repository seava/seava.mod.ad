 ...
 */
Ext.define(Main.ns.ad + "AccessControl_Ui" , {
	...
	_defineDcs_: function() {
		this._getBuilder_()	
		.addDc("ctrl", Ext.create(Main.ns.ad + "AccessControl_Dc" ,{multiEdit:true}))	
		...
		.addDc("dsMtdAccess", Ext.create(Main.ns.ad + "AccessControlDsRpc_Dc" ,{multiEdit:true}))
	...
	,onBtnAsgnRoleToAccessCtrl: function() {
		this._showAsgnWindow_(Main.ns.ad + "AccessControl_Role_Asgn$Ui" ,{dc: "ctrl", objectIdField: "id"});
	}
