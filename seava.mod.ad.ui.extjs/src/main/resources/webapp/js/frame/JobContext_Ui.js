 ...
 */
Ext.define(Main.ns.ad + "JobContext_Ui" , {
	...
	_defineDcs_: function() {
		this._getBuilder_()	
		.addDc("job", Ext.create(Main.ns.ad + "JobContext_Dc" ,{multiEdit:true}))	
		.addDc("params", Ext.create(Main.ns.ad + "JobContextParam_Dc" ,{multiEdit:true}))	
		.addDc("schedule", Ext.create(Main.ns.ad + "JobTimer_Dc" ,{}))	
		.addDc("log", Ext.create(Main.ns.ad + "JobLog_Dc" ,{}))
