 ...
 */
Ext.define(Main.ns.ad + "JobTimer_Dc" , {
	extend: "e4e.dc.AbstractDc",
	filterModel: Main.ns.ad + "JobTimer_DsFilter",
	recordModel: Main.ns.ad + "JobTimer_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "JobTimer_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "JobTimer_Dc$List" , {
...
Ext.define(Main.ns.ad + "JobTimer_Dc$CtxListJobContext" , {
	extend: "e4e.dc.view.AbstractDcvGrid",
...
Ext.define(Main.ns.ad + "JobTimer_Dc$Edit" , {
