 ...
 */
Ext.define(Main.ns.ad + "MyParam_Dc" , {
	extend: "e4e.dc.AbstractDc",
	paramModel: Main.ns.ad + "MyParam_DsParam",
	recordModel: Main.ns.ad + "MyParam_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "MyParam_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "MyParam_Dc$List" , {
...
Ext.define(Main.ns.ad + "MyParam_Dc$InitValuesDateRange" , {
