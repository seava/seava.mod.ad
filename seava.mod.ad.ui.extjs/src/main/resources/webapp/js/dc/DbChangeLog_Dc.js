 ...
 */
Ext.define(Main.ns.ad + "DbChangeLog_Dc" , {
	extend: "e4e.dc.AbstractDc",
	filterModel: Main.ns.ad + "DbChangeLog_DsFilter",
	recordModel: Main.ns.ad + "DbChangeLog_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "DbChangeLog_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "DbChangeLog_Dc$List" , {
