 ...
 */
Ext.define(Main.ns.ad + "AccessControlDs_Dc" , {
	extend: "e4e.dc.AbstractDc",
	recordModel: Main.ns.ad + "AccessControlDs_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "AccessControlDs_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "AccessControlDs_Dc$EditList" , {
...
Ext.define(Main.ns.ad + "AccessControlDs_Dc$CtxEditList" , {
	extend: "e4e.dc.view.AbstractDcvEditableGrid",
