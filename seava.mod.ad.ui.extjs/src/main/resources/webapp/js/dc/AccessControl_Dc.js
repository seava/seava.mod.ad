 ...
 */
Ext.define(Main.ns.ad + "AccessControl_Dc" , {
	extend: "e4e.dc.AbstractDc",
	paramModel: Main.ns.ad + "AccessControl_DsParam",
	recordModel: Main.ns.ad + "AccessControl_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "AccessControl_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "AccessControl_Dc$EditList" , {
...
Ext.define(Main.ns.ad + "AccessControl_Dc$CopyRulesFromSource" , {
