 ...
 */
Ext.define(Main.ns.ad + "JobLog_Dc" , {
	extend: "e4e.dc.AbstractDc",
	filterModel: Main.ns.ad + "JobLog_DsFilter",
	recordModel: Main.ns.ad + "JobLog_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "JobLog_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "JobLog_Dc$List" , {
...
Ext.define(Main.ns.ad + "JobLog_Dc$CtxListJob" , {
	extend: "e4e.dc.view.AbstractDcvGrid",
...
Ext.define(Main.ns.ad + "JobLog_Dc$CtxListJobContext" , {
	extend: "e4e.dc.view.AbstractDcvGrid",
