 ...
 */
Ext.define(Main.ns.ad + "AccessControlAsgn_Dc" , {
	extend: "e4e.dc.AbstractDc",
	recordModel: Main.ns.ad + "AccessControlAsgn_Ds"
});

/* ================= FILTER FORM: Filter ================= */

Ext.define(Main.ns.ad + "AccessControlAsgn_Dc$Filter" , {
...
Ext.define(Main.ns.ad + "AccessControlAsgn_Dc$EditList" , {
...
Ext.define(Main.ns.ad + "AccessControlAsgn_Dc$CtxEditList" , {
	extend: "e4e.dc.view.AbstractDcvEditableGrid",
